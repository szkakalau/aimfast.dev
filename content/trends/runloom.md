...
一个为 Python 自由线程模式实现 Go 风格协程的开源库，引起了开发者社区的广泛讨论。

An open-source library bringing Go-style coroutines to Python's free-threaded mode, generating significant discussion in the developer community.
